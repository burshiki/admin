            ...
            <div className='card-body'>
                <form onSubmit={submitProduct} encType='multipart/form-data'>
                    ...
                    <div class="tab-content" id="myTabContent">
                        ...
                        <div className="tab-pane fade" id="seotags" role="tabpanel" aria-labelledby="seotags-tab" tabindex="0">
                        ...
                        <div className="tab-pane fade" id="otherdetails" role="tabpanel" aria-labelledby="otherdetails-tab" tabindex="0">
                            <div className='row'>
